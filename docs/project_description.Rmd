...
The dataset `spooky.csv`  contains the text data.  It has three columns: `id` giving an identifier for each excerpt, `text` containing the excerpt, and `author` indicating either `EAP`, `HPL`, or `MWS`. 
